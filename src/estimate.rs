...
pub fn estimate(harmonicfile: &str) -> Result<String, Box<dyn Error>> {
    /* Author Gaurav Sablok
     * Universitat Potsdam
     * Date 2024-12-12
     *
     * estimate the harmonic mean of the same query aligned across the different genomes
     * with less divergence so that the estimated divergence value can be linked wot the harmonic
     * mean of the pangenome covered.
     *
     * */
